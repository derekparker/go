...
// m.numa (runtime2.go). With the experiment on it holds one bit: whether
// this M's affinity and task mempolicy have already converged to Layer-1
// BIND-all since the process stood down from fill-one-socket-first
