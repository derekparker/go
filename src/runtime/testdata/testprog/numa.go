...
// package syscall's own generated one, use syscall.SYS_GET_MEMPOLICY
// directly -- it is generated for every linux GOARCH in
...
// the stand-down STW plus the allm affinity walk, so the walk's
// stop-the-world cost is on the record.
func NUMAStandDown() {
